defmodule Appointment.AppointmentsTest do
  ...
  describe "appointments" do
    ...
    @valid_attrs %{date: ~D[2010-04-17], description: "some description", end_time: ~T[14:00:00], start_time: ~T[14:00:00]}
    @update_attrs %{date: ~D[2011-05-18], description: "some updated description", end_time: ~T[15:01:01], start_time: ~T[15:01:01]}
    ...
    test "create_appointment/1 with valid data creates a appointment" do
      ...
      assert appointment.date == ~D[2010-04-17]
    ...
    test "update_appointment/2 with valid data updates the appointment" do
      ...
      assert appointment.date == ~D[2011-05-18]
